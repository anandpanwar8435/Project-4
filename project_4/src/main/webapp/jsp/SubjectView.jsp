...
<%@include file="Header.jsp" %>
	...
	<table>
 <tr>
	<th align="left" class="p1">SubjectName<span style="color: red;">*</span></th>
 ...
 <tr>
   ...
   <td><textarea name="description"  placeholder="Enter Description" style="width: 306px;height:50px; resize: none;"><%=DataUtility.getStringData(bean.getDescription())%></textarea></td>
