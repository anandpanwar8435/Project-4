...
public class SubjectCtl extends BaseCtl{
	...
	protected boolean validate(HttpServletRequest request){
		...
		if(DataValidator.isNull(request.getParameter("subjectName"))){
			...
			request.setAttribute("subjectName","please Enter correct SubjectName");
			pass=false;
		}
...
//		 bean.setSubjectId(DataUtility.getLong(request.getParameter("subjectId")));
		 ...
		 System.out.println("This is Subject Name "+request.getParameter("subjectName"));
		 System.out.println("This is description "+request.getParameter("description"));
		 System.out.println("This is Course Name "+request.getParameter("courseName"));
		 System.out.println("This is id "+request.getParameter("id"));
		 System.out.println("This is courseId "+request.getParameter("courseId"));
