...
public class HTMLUtility {
	...
	public static String getList(String name, String selectedVal,
		  ...
		  StringBuffer sb = new StringBuffer("<select style='width: 312px;  height: 30px;' class='form-control' name='" + name + "'>");
	        ...
	        if (select) {
	            ...
	            sb.append("<option style='width: 312px;  height: 30px;' selected value=''>--------------------------Select----------------------------</option>");
	        }
