...
public class UserRegistrationCtl extends BaseCtl{
	...
	protected void doPost(HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException{
		...
		System.out.println("This is Operation of UserRegistrationCtl "+op);	
		
		UserModel model=new UserModel();
		
		long id=DataUtility.getLong(request.getParameter("id"));
		System.out.println("This is Id of UserRegistrationCtl "+id);
		
		if(OP_SIGN_UP.equalsIgnoreCase(op)){
			
			System.out.println("In SIGNUP Condition of UserRegistrationCtl");
			...
			try{
			System.out.println("This is try block of UserRegistrationCtl ");
				long pk=model.registerUser(bean);
				System.out.println("64757546555555555544444444444444444444444446666666666666666");
