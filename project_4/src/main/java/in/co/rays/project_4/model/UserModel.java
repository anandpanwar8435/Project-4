...
public class UserModel {
	...
	public void update(UserBean bean) throws ApplicationException, DuplicateRecordException{
		...
		try{
			conn=JDBCDataSource.getConnection();
			conn.setAutoCommit(false); 
			PreparedStatement stmt=conn.prepareStatement("update st_user set first_name=?,last_name=?,login=?,password=?,dob=?,mobile_no=?,role_id=?,gender=?,created_by=?,modified_by=?,created_date_time=?,modified_date_time=? where id=?");
...
//		stmt.setString(13,bean.getLastLoginIP());
	...
	public List search(UserBean bean,int pageNo,int pageSize) throws ApplicationException{
		 log.debug("Model search started");
			System.out.println("This is UserModel Search Method Started");
...
//		 System.out.println(bean.getFirstName());
		  ...
		  if (bean != null) {
				System.out.println("This is UserModel  bean != null Started");
	            ...
	            if(pageSize>0){
	            	System.out.println("This is PageSize > 0 Condition");
	            ...
	            try{
	            	System.out.println("This is try of UserModel Search");
	            	conn=JDBCDataSource.getConnection();
	            	PreparedStatement stmt=conn.prepareStatement(sql.toString());
	            	ResultSet rs=stmt.executeQuery();
	            	
	            	while(rs.next()){
	            		System.out.println("This is rs.next  of UserModel Search"+"$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
	    				bean=new UserBean();
	    				bean.setId(rs.getLong(1));
	    				bean.setFirstName(rs.getString(2));
	    				bean.setLastName(rs.getString(3));
	 ...
	 public List list(int pageNo,int pageSize) throws ApplicationException{
		System.out.println("UserModel List Method Started");
