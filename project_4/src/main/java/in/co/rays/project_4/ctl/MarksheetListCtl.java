...
public class MarksheetListCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("MarksheetListCtl doGet Started");
		...
		try {
			System.out.println("Marksheet try");
		list = model.search(bean, pageNo, pageSize);
		System.out.println("Marksheet Search");
		ServletUtility.setBean(bean, request);
		next = model.search(bean, pageNo+1, pageSize);
		System.out.println("Marksheet next search");
		...
		if (list == null || list.size() == 0) {
			System.out.println("66666666777777777777 Marksheet");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("dopost in MarksheetListCtl");
