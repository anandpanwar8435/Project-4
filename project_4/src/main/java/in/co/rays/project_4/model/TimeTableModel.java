...
public class TimeTableModel {
	...
	public Long add(TimeTableBean bean) throws ApplicationException, DuplicateRecordException
	{
		...
		System.out.println("inside Add of tt");
		...
		System.out.println("course name"+coubean.getCourseName());
...
//		System.out.println("______________________________>>>>>"+bean.getExamDate());
	//	TimeTableModel model = new TimeTableModel();
		...
		TimeTableBean bean2 = checkBycss(bean.getCourseId(), bean.getSubId(), bean.getSemester());
...
PreparedStatement ps=conn.prepareStatement("INSERT INTO ST_TIMETABLE VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)");	
			...
			ps.setLong(4, bean.getSubId());
			ps.setString(5, bean.getSubName());
	...
	public void update(TimeTableBean bean) throws ApplicationException, DuplicateRecordException {
		...
		CourseBean coubean=    coumodel.findByPK(bean.getCourseId());
		String cname=coubean.getCourseName();
		System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"+cname);
		//System.out.println("###########################"+bean.getSubName() +"" +bean.getCourseName());
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE ST_TIMETABLE SET SUB_ID=?,SUB_NAME=?,COURSE_ID=?,COURSE_NAME=?,SEMESTER=?,EXAM_DATE=?,EXAM_TIME=?,DESCRIPTION=?,CREATED_BY=?,MODIFIED_BY=?,CREATED_DATE_TIME=?,MODIFIED_DATE_TIME=? WHERE ID=?");
			
			pstmt.setLong(1, bean.getSubId());
...
//				System.out.println("sql statement ==="+d);
  ...
  //  	java.util.Date ExamDAte,String ExamTime
    	StringBuffer sql = new StringBuffer("SELECT * FROM ST_TIMETABLE WHERE Course_ID=? AND SUB_ID=? AND Semester=?");
   ...
   public static TimeTableBean checkBysemester(long CourseId,long SubjectId,String semester,java.util.Date ExamDAte)
    {
    	...
    	StringBuffer sql = new StringBuffer("SELECT * FROM TIMETABLE WHERE COURSE_ID=? AND SUB_ID=? AND"
