...
public class MyProfileCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
		...
		String op = DataUtility.getString(request.getParameter("operation"));
        System.out.println("This is operation "+request.getParameter("operation"));
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
		...
		long id = UserBean.getId();
		System.out.println("This is Id of doPost "+id);
		
		String op = DataUtility.getString(request.getParameter("operation"));
		System.out.println("This is Operation of dopost "+op);
		// get model
		UserModel model = new UserModel();

		if (OP_SAVE.equalsIgnoreCase(op)) {
			System.out.println("In Save Operation");
			...
			try {
				...
				System.out.println("6555555555555555555555555555555555555555555555555555555");
				ServletUtility.setBean(bean, request);
